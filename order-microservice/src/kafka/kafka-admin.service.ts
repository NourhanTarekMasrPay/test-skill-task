...
export class KafkaAdminService implements OnModuleInit, OnModuleDestroy {
  ...
  private readonly topicsToCreate: ITopicConfig[] = [
    { topic: KAFKA_CONFIG.TOPICS.ORDER_CREATED, numPartitions: 1, replicationFactor: 1 },
    { topic: KAFKA_CONFIG.TOPICS.ORDER_DELETED, numPartitions: 1, replicationFactor: 1 },
  ];
